...
class Ara3ClassProcessor(DataProcessor):
    """
    Example for a data processor.
    """

    # Set this to the name of the task
    TASK_NAME = "arabic_3_class"
    ...
    LABELS = ["no_ref", "positive", "negative"]
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, Ara3ClassProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, Ara3ClassProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, Ara3ClassProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, Ara3ClassProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return Ara3ClassProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path) as f:
            ...
            for idx, row in enumerate(reader):
                ...
                label = row[Ara3ClassProcessor.LABEL_COLUMN]
                text_a = row[Ara3ClassProcessor.TEXT_A_COLUMN]
                text_b = row[Ara3ClassProcessor.TEXT_B_COLUMN] if Ara3ClassProcessor.TEXT_B_COLUMN >= 0 else None
                example = InputExample(guid=guid, text_a=text_a, text_b=text_b, label=label)
                examples.append(example)

        return examples
    
class AraIsPersonalProcessor(DataProcessor):
    """
    Example for a data processor.
    """

    # Set this to the name of the task
    TASK_NAME = "arabic_is_personal"
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of train examples
        """
        return self._create_examples(os.path.join(data_dir, AraIsPersonalProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of dev examples
        """
        return self._create_examples(os.path.join(data_dir, AraIsPersonalProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of test examples
        """
        return self._create_examples(os.path.join(data_dir, AraIsPersonalProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of unlabeled examples
        """
        return self._create_examples(os.path.join(data_dir, AraIsPersonalProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return AraIsPersonalProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path) as f:
            ...
            for idx, row in enumerate(reader):
                guid = "%s-%s" % (set_type, idx)
                label = row[AraIsPersonalProcessor.LABEL_COLUMN]
                text_a = row[AraIsPersonalProcessor.TEXT_A_COLUMN]
                text_b = row[AraIsPersonalProcessor.TEXT_B_COLUMN] if AraIsPersonalProcessor.TEXT_B_COLUMN >= 0 else None
                example = InputExample(guid=guid, text_a=text_a, text_b=text_b, label=label)
                examples.append(example)

        return examples
    
class AraMultilabelProcessor(DataProcessor):
    """
    Example for a data processor.
    """
    ...
    # Set this to a list of all labels in the train + test data
    LABELS = ["no_ref", "neutral", "positive", "negative"]
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of train examples
        """
        return self._create_examples(os.path.join(data_dir, AraMultilabelProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of dev examples
        """
        return self._create_examples(os.path.join(data_dir, AraMultilabelProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of test examples
        """
        return self._create_examples(os.path.join(data_dir, AraMultilabelProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of unlabeled examples
        """
        return self._create_examples(os.path.join(data_dir, AraMultilabelProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return AraMultilabelProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path) as f:
            ...
            for idx, row in enumerate(reader):
                guid = "%s-%s" % (set_type, idx)
                label = row[AraMultilabelProcessor.LABEL_COLUMN]
                text_a = row[AraMultilabelProcessor.TEXT_A_COLUMN]
                text_b = row[AraMultilabelProcessor.TEXT_B_COLUMN] if AraMultilabelProcessor.TEXT_B_COLUMN >= 0 else None
                example = InputExample(guid=guid, text_a=text_a, text_b=text_b, label=label)
                examples.append(example)
...
PROCESSORS = {
    "arabic_3_class": Ara3ClassProcessor,
    "arabic_is_personal" : AraIsPersonalProcessor,
    "arabic_multilabel": AraMultilabelProcessor,
    "mnli": MnliProcessor,
