...
from transformers import InputExample, AdamW, get_linear_schedule_with_warmup, PreTrainedTokenizer, BertForMaskedLM, FunnelForMaskedLM, \
    FunnelConfig, FunnelForMaskedLM, FunnelTokenizer, FunnelForSequenceClassification, \
...
MODEL_CLASSES = {
    ...
    'funnel': {
        ...
        SEQUENCE_CLASSIFIER_WRAPPER: FunnelForSequenceClassification,
        MLM_WRAPPER: FunnelForMaskedLM
    },
    'roberta': {
